...
public class EntityParameterDAOImpl implements EntityParameterDAO {
    ...
    public List<EntityParameter> getAllParameters(final Long entityId) {
        String sql = "SELECT * FROM ENTITY_PARAMETER WHERE ENTITY_ID=?";
    ...
    public EntityParameter getParameter(final Long entityId, final Long parameterID) {
        String sql = "SELECT * FROM ENTITY_PARAMETER WHERE  entity_Id=? and parameter_id=?";
        return template.query(sql, new PreparedStatementSetter() {
            @Override
            public void setValues(PreparedStatement ps) throws SQLException {
                ps.setLong(1,  entityId);
    ...
    public TreeSet<Date> getAllDatesByStudyLoad(final Long idValue) {
        String sql = "SELECT * FROM ENTITY_PARAMETER WHERE ID_VALUE=?";
    ...
    public Map<Date, Double> getAllMarksByStudent(TreeSet<Date> dates, final Long idValue, final Long entityId) {
        ...
        for (final Date date : dates){
            String sql = "SELECT * FROM ENTITY_PARAMETER WHERE ENTITY_ID =? and ID_VALUE=? and DATE_VALUE =?" ;
    ...
    public TreeSet<Long> getStudyLoadByGroup(final Long id) {
        String sql = "SELECT * FROM ENTITY_PARAMETER WHERE ID_VALUE=? and PARAMETER_ID=?";
    ...
    public EntityParameter checkLogin(final String login) {
        ...
        String sql = "SELECT * FROM ENTITY_PARAMETER WHERE  STRING_VALUE=? and PARAMETER_ID=?";
        return template.query(sql,  new PreparedStatementSetter() {
            @Override
            public void setValues(PreparedStatement ps) throws SQLException {
    ...
    public EntityParameter checkPassword(final Long entityId, final String password) {
        String sql = "SELECT * FROM ENTITY_PARAMETER WHERE  STRING_VALUE=? and PARAMETER_ID=? and ENTITY_ID=?";
        return template.query(sql, new PreparedStatementSetter() {
            @Override
            public void setValues(PreparedStatement ps) throws SQLException {
